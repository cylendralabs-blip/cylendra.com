-- ============================================
-- تشخيص مشكلة OKX - فحص شامل
-- ============================================
-- يمكنك تنفيذ هذا في Supabase Dashboard > SQL Editor
-- Copy and paste this entire file into SQL Editor and run it
...
-- ============================================
-- 6. فحص آخر محاولة جلب رصيد (من logs إذا كان متاحاً)
-- ============================================
SELECT 
  '=== آخر محاولات جلب الرصيد ===' as section;

-- هذا الاستعلام يعرض آخر تحديث لكل API Key
SELECT 
  ak.id,
  ak.platform,
  ak.testnet,
