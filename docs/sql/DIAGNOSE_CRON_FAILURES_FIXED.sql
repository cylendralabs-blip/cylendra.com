-- ========================================
-- تشخيص فشل Cron Jobs (مصحح نهائياً)
-- ========================================
...
-- 3. عرض آخر تنفيذ فاشل لكل Job (استخدام start_time - مصحح)
SELECT 
  j.jobname,
  jrd.start_time,
  jrd.end_time,
...
-- 4. عرض آخر 5 تنفيذات لجميع Jobs (استخدام start_time - مصحح)
SELECT 
  j.jobname,
  jrd.start_time,
  jrd.end_time,
...
-- 5. عرض تفاصيل الأخطاء في آخر 5 أيام (مصحح)
SELECT 
  j.jobname,
  jrd.start_time,
  jrd.end_time,
