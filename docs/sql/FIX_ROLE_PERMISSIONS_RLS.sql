-- FIX_ROLE_PERMISSIONS_RLS.sql
-- This script fixes the RLS policy on the 'public.role_permissions' table
-- to allow owners to manage permissions using the new RBAC system.
