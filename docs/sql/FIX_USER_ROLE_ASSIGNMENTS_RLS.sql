-- FIX_USER_ROLE_ASSIGNMENTS_RLS.sql
-- This script fixes the RLS policy on the 'public.user_role_assignments' table
-- to allow users to view their own roles and owners/admins to view all roles
